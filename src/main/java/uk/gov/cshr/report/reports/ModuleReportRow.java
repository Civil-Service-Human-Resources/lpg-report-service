...
public class ModuleReportRow {
    ...
    public boolean isAssociateLearning() { return associatedLearning; }

    public void setAssociateLearning(boolean associateLearning) { this.associatedLearning = associateLearning; }
